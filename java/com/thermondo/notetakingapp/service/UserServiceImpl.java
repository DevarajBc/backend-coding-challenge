...
public class UserServiceImpl implements UserService{
    ...
    /**
     * The function registers the user in the system.
     * @param userRequest
     * @return
     */
    @Override
    ...
    /**
     * The function login the user and creates the entry in the system.
     * @param userRequest
     * @return userContext.
     */
    @Override
    ...
    /**
     * Generates the random session token.
     * @return
     */
